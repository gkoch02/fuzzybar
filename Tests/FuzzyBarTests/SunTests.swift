...
final class SunTests: XCTestCase {
    ...
    func testTimeZoneGivesTheReferenceCity() {
        ...
        // An older spelling still finds its city.
        XCTAssertNotNil(SunSettings.zoneLocation(TimeZone(identifier: "Asia/Calcutta")!))
        XCTAssertEqual(SunSettings.cityName(TimeZone(identifier: "Asia/Calcutta")!), "Kolkata")
